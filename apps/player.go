...
func APP_dplayer(window *wm.Window) {
	...
	currentTheme := "blue"
	colorFG := wm.GetColor[currentTheme]["vivid"]
	colorBG := wm.GetColor[currentTheme]["faded"]
	colorMG := wm.GetColor[currentTheme]["normal"]
    ...
    container.Get("style").Set("backgroundColor", wm.GetColor[currentTheme]["faded"])
    ...
    timeDisplay.Get("style").Set("color", wm.GetColor[currentTheme]["vivid"])
    ...
    statusText.Get("style").Set("color", wm.GetColor[currentTheme]["vivid"])
